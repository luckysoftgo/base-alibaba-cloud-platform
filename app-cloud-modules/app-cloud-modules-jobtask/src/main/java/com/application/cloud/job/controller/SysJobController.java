package com.application.cloud.job.controller;

import com.application.cloud.common.core.exception.job.TaskException;
...
public class SysJobController extends BaseController
{
     ...
     * 查询定时任务列表
     */
    @PreAuthorize("@auth.hasPermi('monitor:job:list')")
    @GetMapping("/list")
     ...
     * 导出定时任务列表
     */
    @PreAuthorize("@auth.hasPermi('monitor:job:export')")
     ...
     * 获取定时任务详细信息
     */
    @PreAuthorize("@auth.hasPermi('monitor:job:query')")
     ...
     * 定时任务状态修改
     */
    @PreAuthorize("@auth.hasPermi('monitor:job:changeStatus')")
    @Log(title = "定时任务", businessType = BusinessType.UPDATE)
     ...
     * 删除定时任务
     */
    @PreAuthorize("@auth.hasPermi('monitor:job:remove')")
