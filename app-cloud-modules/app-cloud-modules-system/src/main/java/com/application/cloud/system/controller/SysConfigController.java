...
public class SysConfigController extends BaseController
{
     ...
     * 获取参数配置列表
     */
    @PreAuthorize("@auth.hasPermi('system:config:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@auth.hasPermi('system:config:export')")
    @PostMapping("/export")
     ...
     * 新增参数配置
     */
    @PreAuthorize("@auth.hasPermi('system:config:add')")
     ...
     * 修改参数配置
     */
    @PreAuthorize("@auth.hasPermi('system:config:edit')")
     ...
     * 删除参数配置
     */
    @PreAuthorize("@auth.hasPermi('system:config:remove')")
