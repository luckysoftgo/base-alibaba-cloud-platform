...
public class SysPostController extends BaseController
{
     ...
     * 获取岗位列表
     */
    @PreAuthorize("@auth.hasPermi('system:post:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@auth.hasPermi('system:post:export')")
    @PostMapping("/export")
     ...
     * 根据岗位编号获取详细信息
     */
    @PreAuthorize("@auth.hasPermi('system:post:query')")
     ...
     * 新增岗位
     */
    @PreAuthorize("@auth.hasPermi('system:post:add')")
     ...
     * 修改岗位
     */
    @PreAuthorize("@auth.hasPermi('system:post:edit')")
     ...
     * 删除岗位
     */
    @PreAuthorize("@auth.hasPermi('system:post:remove')")
