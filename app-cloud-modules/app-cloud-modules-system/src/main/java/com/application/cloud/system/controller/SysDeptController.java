...
public class SysDeptController extends BaseController
{
     ...
     * 获取部门列表
     */
    @PreAuthorize("@auth.hasPermi('system:dept:list')")
    @GetMapping("/list")
     ...
     * 根据部门编号获取详细信息
     */
    @PreAuthorize("@auth.hasPermi('system:dept:query')")
     ...
     * 新增部门
     */
    @PreAuthorize("@auth.hasPermi('system:dept:add')")
     ...
     * 修改部门
     */
    @PreAuthorize("@auth.hasPermi('system:dept:edit')")
     ...
     * 删除部门
     */
    @PreAuthorize("@auth.hasPermi('system:dept:remove')")
