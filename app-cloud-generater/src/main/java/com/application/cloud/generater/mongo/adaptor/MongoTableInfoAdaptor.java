package com.application.cloud.generater.mongo.adaptor;

import com.application.cloud.generater.mongo.entity.MongoDefinition;
import com.application.cloud.generater.mongo.entity.MongoType;
 ...
 *
 * @author : 孤狼
 * @NAME: MongoTableInfoAdaptor
 * @DESC: MongoTableInfoAdaptor类设计
 **/
public class MongoTableInfoAdaptor {
	...
	public static List<Map<String, String>> columnInfo(MongoDefinition mongoDefinition) {
		...
		for (MongoDefinition definition : child) {
			...
			String type = MongoType.typeInfo(definition.getType());
