...
public class OKHttpClientUtil {
	...
	private long keepAliveDuration = 200;
	 ...
	 * @return
	 */
	private ConnectionPool getConnPool() {
	 ...
	 * @return
	 */
	public static OKHttpClientUtil builder() {
	 ...
	 * @return
	 */
	public OKHttpClientUtil url(String url) {
		this.url = url;
		return this;
	}
	 ...
	 * @return
	 */
	public OKHttpClientUtil addParam(String key, String value) {
		if (paramMap == null) {
	 ...
	 * @return
	 */
	public OKHttpClientUtil addHeader(String key, String value) {
		if (headerMap == null) {
	 ...
	 * @return
	 */
	public OKHttpClientUtil post(boolean isJsonPost) {
	...
	public static void main(String[] args) {
		...
		OKHttpClientUtil.builder().url("请求地址，http/https都可以")
				// 有参数的话添加参数，可多个
				.addParam("参数名", "参数值")
				.addParam("参数名", "参数值")
				// 也可以添加多个
		...
		OKHttpClientUtil.builder().url("")
				.post(false)
				.async();
		
		//普通异步请求,并将结果进行处理.
		OKHttpClientUtil.builder().url("").post(false).async(new OKHttpClientUtil.ICallBack() {
			@Override
